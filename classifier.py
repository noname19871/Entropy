...
print(predict(["кстати нашел еще один книжный магазин в лондоне который может претендовать на звание лучшего несмотря на свои скромные размеры. пожалуй самая высокая концентрация лучших книг на квадратный метр.    недалеко от слоун скуэйр. лондон книги .."]))
